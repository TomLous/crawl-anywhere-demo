...
# Loaded from: http://git.eclipse.org/c/jetty/org.eclipse.jetty.project.git/plain/jetty-distribution/src/main/resources/bin/jetty.sh
# Modified by Tom Lous (added LSB)
